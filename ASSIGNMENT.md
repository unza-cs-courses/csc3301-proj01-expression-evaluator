...
Your calculations must be accurate to **6 decimal places**.
...
evaluate("sqrt(3.4913)")  # Returns sqrt of your test constant
evaluate("abs(-55.4523)")  # Returns 55.4523
```
